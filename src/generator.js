...
exports.JsonToTypeScriptGenerator = void 0;
exports.stringToTypeScript = stringToTypeScript;
exports.fileToTypeScript = fileToTypeScript;
...
exports.JsonToTypeScriptGenerator = JsonToTypeScriptGenerator;
/**
 * Utility function to parse JSON string and generate type
 */
function stringToTypeScript(jsonString, options) {
    try {
 ...
 */
async function fileToTypeScript(filePath, options) {
    try {
